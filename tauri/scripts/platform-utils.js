 ...
 * For Mnemonics Tauri Application
 * 
...
function getPlatformConfig() {
    ...
    const configs = {
        win32: {
            ...
            installerPaths: [
                'msi\\Mnemonics_1.0.0_x64_en-US.msi',
                'nsis\\Mnemonics_1.0.0_x64-setup.exe'
            ]
        },
        darwin: {
            name: 'macOS',
        ...
        linux: {
            ...
            outputDir: 'src-tauri/target/release/bundle',
            installerPaths: [
                'deb/mnemonics_1.0.0_amd64.deb',
                'appimage/mnemonics_1.0.0_amd64.AppImage',
                'rpm/mnemonics-1.0.0-1.x86_64.rpm'
            ]
        }
    };
